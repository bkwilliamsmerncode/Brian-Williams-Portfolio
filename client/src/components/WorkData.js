...
const projectCardData = [
    ...
    },
    {
        imgsrc: gym,
        title: 'Gym Exercises',
        text: "In this project I used Rapid API's Youtube and Search and a ExerciseDB to search for exercises and link to youtube videos demonstrating those exercises.",
